...
import PaintBucket from "@app/graphics/px-icon-bucket.svg";
import Pencil from "@app/graphics/px-icon-pencil.svg";
import Eyedropper from "@app/graphics/px-icon-eyedropper.svg";
